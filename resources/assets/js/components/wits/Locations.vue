        ...
        <aside class="col-md-3 col-xs-12">
            <div id="selectDropdowns">
                ...
                <div class="panel panel-default">
                    ...
                    <select v-model="selectedCampus" class="form-control" :size="setSelectSizeCampus()"
                            ref="selectItem">
                ...
                <div class="panel panel-default" v-if="selectedCampus">
                    ...
                    <select v-model="selectedBuilding" class="form-control" :size="setSelectSizeBuilding()"
                            ref="selectItem">
                        <option value="" style="color:#c3c3c3">Select/Add a Building</option>
                        <option v-for="building in selectedCampus.buildings" :value="building"> {{building.name}}
                        </option>
                    </select>
                </div>
                ...
                <div class="panel panel-default" v-if="selectedBuilding && selectedCampus">
                    ...
                    <select v-model="selectedRoom" class="form-control" :size="setSelectSizeRoom()">
                        ...
                        <option v-for="room in selectedBuilding.rooms" :value="room">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select v-model='roomStyle' class="form-control">
                                        <option v-for="roomstyle in roomStyles" :value="roomstyle.id">
                                            {{roomstyle.name}}
                                        </option>
                                    </select>
                                </div>
                ...
                <div id="current-item-tabs" style="margin:20px 0">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#inventory" aria-controls="inventory" role="tab" data-toggle="tab"
                               class="text-capitalize">inventory</a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#software" aria-controls="software" role="tab" data-toggle="tab"
                               class="text-capitalize">software
                                <i id="software-btn" class="fa fa-plus fa-fw" data-toggle="collapse"
                                   data-target="#addSoftware" aria-expanded="false" aria-controls="addSoftware"/>
                            </a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#department" aria-controls="department" role="tab" data-toggle="tab"
                               class="text-capitalize">department</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="inventory">
                            ...
                            <!---->
                            <inventory-table :data="currentItem.assets" />
                            <!---->
