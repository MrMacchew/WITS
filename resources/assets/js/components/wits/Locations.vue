                ...
                <div id="current-item-tabs" style="margin:20px 0">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation">
                            <a href="#room" aria-controls="room" role="tab" data-toggle="tab" class="text-capitalize">{{currentItem.type}}</a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#inventory" aria-controls="inventory" role="tab" data-toggle="tab" class="text-capitalize">inventory</a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#software" aria-controls="software" role="tab" data-toggle="tab" class="text-capitalize">software
                            <i id="software-btn" class="fa fa-plus fa-fw" data-toggle="collapse" data-target="#addSoftware" aria-expanded="false" aria-controls="addSoftware" />
                        </a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#department" aria-controls="department" role="tab" data-toggle="tab" class="text-capitalize">department</a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#media" aria-controls="media" role="tab" data-toggle="tab" class="text-capitalize">media</a>
                        </li>

                        <li role="presentation" v-show="currentItem.type == 'room'">
                            <a href="#support" aria-controls="support" role="tab" data-toggle="tab" class="text-capitalize">Support</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="support">
                            ...
                            <div v-if="currentItem.supports && currentItem.supports.length > 0">
                                <h3>Room Support</h3>
                                <ul>
                                    <li v-for="user in currentItem.supports">
                            ...
                            <form class="form-horizontal">
                                <div>
                                    ...
                                    <multiselect v-model="currentItem.supports" :options="supports" 
                                    :multiple="true" track-by="username" label="username" :hideSelected="true" :close-on-select="false" 
...
export default {
    ...
    methods: {
            ...
            axios.post('/api/v1/buildings', this.newBuilding)
                .then(function(response) {
                    vm.campuses[vm.currentItem.index.campus]
                        .buildings.unshift(response.data)
        ...
        onSelectSupport: function(e) {
            ...
            axios.post('/api/v1/rooms/' + this.currentItem.id + '/sync/supports', data)
                .then(function(response) {
                    console.clear();
                    var items = response.data
                    console.log(items);
                    ...
                    _.each(items['attached'], function(item) {
                        toastr["success"]("Added Support: " + item.first_name + " " + item.last_name)
                    })

                    _.each(items['detached'], function(item) {
                        toastr["warning"]("Removed Support: " + item.first_name + " " + item.last_name)
                    })
                })
                .catch(vm.handleError);
        },
                        ...
                        action: function() {
                            axios.post('/api/v1/software/' + data.id, data)
                                .then(function(response) {
                                    ...
                                    var software_index = _.findIndex(rooms.software, function(room) {
